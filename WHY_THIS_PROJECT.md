...
**Legal Compliance Escalation Triage RAG Assistant** is not a static prompt demo. It is a runnable full-stack AI application for **Legal Compliance Escalation Triage Simple RAG - Beginner Custom 15** that demonstrates the core expectations of a **Simple RAG** project at **Beginner** difficulty.
